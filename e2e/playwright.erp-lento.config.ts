...
export default defineConfig({
  ...
  // DB lógico 3: dedicado a esta suíte, separado do "2" usado pela suíte
  // Playwright principal (ver playwright.config.ts/global-setup.ts) — os
  // dois trios de serviços rodam ao mesmo tempo em portas diferentes, então
  // também precisam de Redis lógicos diferentes.
  globalSetup: "./global-setup-erp-lento.ts",
  fullyParallel: false,
  workers: 1,
  timeout: 35_000,
  ...
  webServer: [
    ...
    },
    {
      ...
      env: {
        PORT: "3002",
        ERP_MOCK_URL: "http://localhost:4001",
        ERP_SIM_MODE: "always-timeout",
