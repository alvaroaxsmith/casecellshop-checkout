...
Backend reiniciado com `ERP_SIM_MODE=always-http-error` — o `erp-mock` responde com HTTP `503` (não `success: false` num `200`, como no Bloco 2). `capinha-preta`, disparado via `scripts/scenarios.sh erp-http-error`. O que essa captura fecha: `ErpService.call()` sempre teve `if (!res.ok) { ...; return { success: false }; }`, mas até esta captura esse trecho só era exercitado com `fetch` mockado em `erp.service.spec.ts` — aqui é o `erp-mock` de verdade devolvendo `503`, três vezes.

```
[Nest] 74098  LOG   [HTTP] --> POST /checkout requestId=7fbec0c8 ip=::1
[Nest] 74098  LOG   [CheckoutService] Checkout recebido — requestId=7fbec0c8 productId=capinha-preta quantity=1 idempotencyKey=manual-1789429782-19749
[Nest] 74098  DEBUG [IdempotencyService] Consulta de idempotência — idempotencyKey=manual-1789429782-19749 result=miss
[Nest] 74098  LOG   [OrdersService] Pedido criado — orderId=ord_000001 productId=capinha-preta quantity=1 status=pending
[Nest] 74098  LOG   [ProductsService] Estoque reservado — orderId=ord_000001 productId=capinha-preta quantity=1 remainingAvailable=4 ttlMs=120000
[Nest] 74098  DEBUG [IdempotencyService] Resposta de sucesso armazenada — idempotencyKey=manual-1789429782-19749 orderId=ord_000001
[Nest] 74098  LOG   [CheckoutService] Checkout aceito, status=pending; liquidação com o ERP inicia em segundo plano — orderId=ord_000001 requestId=7fbec0c8 productId=capinha-preta quantity=1 idempotencyKey=manual-1789429782-19749
[Nest] 74098  LOG   [CheckoutService] Chamando o ERP — orderId=ord_000001 attempt=1/3 timeoutMs=3000
[Nest] 74098  DEBUG [ErpService] Chamando erp-mock — url=http://localhost:4000/erp/orders simMode=always-http-error
[Nest] 74098  LOG   [HTTP] <-- POST /checkout requestId=7fbec0c8 status=202 durationMs=3.0
{"orderId":"ord_000001","status":"pending","statusUrl":"/orders/ord_000001"}

-- polling GET /orders/ord_000001 (pings mostrando "pending" omitidos) --

[Nest] 74098  WARN  [ErpService] erp-mock respondeu com erro, tratando como falha — httpStatus=503 durationMs=693
[Nest] 74098  WARN  [CheckoutService] Tentativa de liquidação falhou (ERP indisponível, lento ou recusou) — orderId=ord_000001 attempt=1/3
[Nest] 74098  LOG   [CheckoutService] Aguardando antes da próxima tentativa — orderId=ord_000001 backoffMs=1000

[Nest] 74098  LOG   [CheckoutService] Chamando o ERP — orderId=ord_000001 attempt=2/3 timeoutMs=3000
[Nest] 74098  DEBUG [ErpService] Chamando erp-mock — url=http://localhost:4000/erp/orders simMode=always-http-error
[Nest] 74098  WARN  [ErpService] erp-mock respondeu com erro, tratando como falha — httpStatus=503 durationMs=783
[Nest] 74098  WARN  [CheckoutService] Tentativa de liquidação falhou (ERP indisponível, lento ou recusou) — orderId=ord_000001 attempt=2/3
[Nest] 74098  LOG   [CheckoutService] Aguardando antes da próxima tentativa — orderId=ord_000001 backoffMs=2000

[Nest] 74098  LOG   [CheckoutService] Chamando o ERP — orderId=ord_000001 attempt=3/3 timeoutMs=3000
[Nest] 74098  DEBUG [ErpService] Chamando erp-mock — url=http://localhost:4000/erp/orders simMode=always-http-error
[Nest] 74098  WARN  [ErpService] erp-mock respondeu com erro, tratando como falha — httpStatus=503 durationMs=1987
[Nest] 74098  WARN  [CheckoutService] Tentativa de liquidação falhou (ERP indisponível, lento ou recusou) — orderId=ord_000001 attempt=3/3
[Nest] 74098  LOG   [ProductsService] Reserva liberada, estoque volta a ficar disponível — orderId=ord_000001 productId=capinha-preta quantity=1
[Nest] 74098  WARN  [OrdersService] Pedido marcado como failed — orderId=ord_000001 status=failed errorCode=ERP_PROCESSING_FAILED errorMessage="Não conseguimos concluir seu pedido agora. Tente novamente em instantes."
[Nest] 74098  ERROR [CheckoutService] Pedido falhou definitivamente após esgotar as tentativas; estoque liberado — orderId=ord_000001 attempts=3

[Nest] 74098  LOG   [HTTP] --> GET /orders/ord_000001 requestId=731f71f5 ip=::1
[Nest] 74098  LOG   [HTTP] <-- GET /orders/ord_000001 requestId=731f71f5 status=200 durationMs=0.3
{"orderId":"ord_000001","status":"failed","error":{"code":"ERP_PROCESSING_FAILED","message":"Não conseguimos concluir seu pedido agora. Tente novamente em instantes."}}
```
...
Backend reiniciado com `ERP_SIM_MODE=always-reset` — o `erp-mock` fecha o socket (`req.socket.destroy()`) em vez de responder qualquer coisa. `capinha-preta`, disparado via `scripts/scenarios.sh erp-reset`. Repare a diferença de mensagem em relação ao Bloco 12: ali o `fetch()` **resolve** com uma resposta não-ok (`httpStatus=503`); aqui o `fetch()` **rejeita** (`reason=fetch failed`) — é o outro branch de `settleWithErp`, o `try/catch` em volta de `this.erp.call()`, que antes desta captura só era exercitado com `mockRejectedValue` em teste unitário.

```
[Nest] 74624  LOG   [HTTP] --> POST /checkout requestId=a7d582e9 ip=::1
[Nest] 74624  LOG   [CheckoutService] Checkout recebido — requestId=a7d582e9 productId=capinha-preta quantity=1 idempotencyKey=manual-1789429851-27425
[Nest] 74624  DEBUG [IdempotencyService] Consulta de idempotência — idempotencyKey=manual-1789429851-27425 result=miss
[Nest] 74624  LOG   [OrdersService] Pedido criado — orderId=ord_000001 productId=capinha-preta quantity=1 status=pending
[Nest] 74624  LOG   [ProductsService] Estoque reservado — orderId=ord_000001 productId=capinha-preta quantity=1 remainingAvailable=4 ttlMs=120000
[Nest] 74624  DEBUG [IdempotencyService] Resposta de sucesso armazenada — idempotencyKey=manual-1789429851-27425 orderId=ord_000001
[Nest] 74624  LOG   [CheckoutService] Checkout aceito, status=pending; liquidação com o ERP inicia em segundo plano — orderId=ord_000001 requestId=a7d582e9 productId=capinha-preta quantity=1 idempotencyKey=manual-1789429851-27425
[Nest] 74624  LOG   [CheckoutService] Chamando o ERP — orderId=ord_000001 attempt=1/3 timeoutMs=3000
[Nest] 74624  DEBUG [ErpService] Chamando erp-mock — url=http://localhost:4000/erp/orders simMode=always-reset
[Nest] 74624  LOG   [HTTP] <-- POST /checkout requestId=a7d582e9 status=202 durationMs=2.4
{"orderId":"ord_000001","status":"pending","statusUrl":"/orders/ord_000001"}

[Nest] 74624  WARN  [CheckoutService] Chamada ao ERP rejeitou (tratada como falha desta tentativa) — orderId=ord_000001 attempt=1/3 reason=fetch failed
[Nest] 74624  WARN  [CheckoutService] Tentativa de liquidação falhou (ERP indisponível, lento ou recusou) — orderId=ord_000001 attempt=1/3
[Nest] 74624  LOG   [CheckoutService] Aguardando antes da próxima tentativa — orderId=ord_000001 backoffMs=1000

[Nest] 74624  LOG   [CheckoutService] Chamando o ERP — orderId=ord_000001 attempt=2/3 timeoutMs=3000
[Nest] 74624  DEBUG [ErpService] Chamando erp-mock — url=http://localhost:4000/erp/orders simMode=always-reset
[Nest] 74624  WARN  [CheckoutService] Chamada ao ERP rejeitou (tratada como falha desta tentativa) — orderId=ord_000001 attempt=2/3 reason=fetch failed
[Nest] 74624  WARN  [CheckoutService] Tentativa de liquidação falhou (ERP indisponível, lento ou recusou) — orderId=ord_000001 attempt=2/3
[Nest] 74624  LOG   [CheckoutService] Aguardando antes da próxima tentativa — orderId=ord_000001 backoffMs=2000

[Nest] 74624  LOG   [CheckoutService] Chamando o ERP — orderId=ord_000001 attempt=3/3 timeoutMs=3000
[Nest] 74624  DEBUG [ErpService] Chamando erp-mock — url=http://localhost:4000/erp/orders simMode=always-reset
[Nest] 74624  WARN  [CheckoutService] Chamada ao ERP rejeitou (tratada como falha desta tentativa) — orderId=ord_000001 attempt=3/3 reason=fetch failed
[Nest] 74624  WARN  [CheckoutService] Tentativa de liquidação falhou (ERP indisponível, lento ou recusou) — orderId=ord_000001 attempt=3/3
[Nest] 74624  LOG   [ProductsService] Reserva liberada, estoque volta a ficar disponível — orderId=ord_000001 productId=capinha-preta quantity=1
[Nest] 74624  WARN  [OrdersService] Pedido marcado como failed — orderId=ord_000001 status=failed errorCode=ERP_PROCESSING_FAILED errorMessage="Não conseguimos concluir seu pedido agora. Tente novamente em instantes."
[Nest] 74624  ERROR [CheckoutService] Pedido falhou definitivamente após esgotar as tentativas; estoque liberado — orderId=ord_000001 attempts=3

[Nest] 74624  LOG   [HTTP] --> GET /orders/ord_000001 requestId=a50ca8c1 ip=::1
[Nest] 74624  LOG   [HTTP] <-- GET /orders/ord_000001 requestId=a50ca8c1 status=200 durationMs=0.4
{"orderId":"ord_000001","status":"failed","error":{"code":"ERP_PROCESSING_FAILED","message":"Não conseguimos concluir seu pedido agora. Tente novamente em instantes."}}
```
